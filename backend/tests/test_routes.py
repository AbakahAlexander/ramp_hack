...
def test_route_from_image_opencv_spatial(client: TestClient):
    from pathlib import Path

    walls = client.get("/api/v1/walls").json()
    wall_id = walls[0]["id"]
    fixture = Path(__file__).parent / "fixtures" / "wall_routes.png"
    assert fixture.is_file(), "missing wall_routes.png fixture"
